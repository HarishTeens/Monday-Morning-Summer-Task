		...
		<div class="container">
			...
			<div class="body-section">
                ...
                ?> 
					...
					<div class="form-group">
						<select id='category' class="form-control" name="category">
							...
							<?php
								...
								foreach ($tabs as $tab) { ?>
									<option value="<?php echo $tab->tab_name; ?>" 
									<?php if($tab->tab_name==$article['Category']){ ?>
										selected="selected"
									<?php } ?>
									><?php echo $tab->tab_name; ?></option>	
							<?php }
					...
					<div class="form-group">
						<textarea class="form-control" rows="20" cols="30" name="content" placeholder="Article content goes here" ><?php echo $article['Content'] ?></textarea>
					</div>		
					<div class="form-group">
