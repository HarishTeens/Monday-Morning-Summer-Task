...
<html>
	<head>		
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/cs/pollbrowse.css') ?>">
		...
		<div class="container">
			...
			<div class="body-section">
				<ul class="articles" type="none">
					<?php foreach ($polls->result() as $row) { ?>
					<li class="article">
						...
						<div class="article-details">						
							...
							<div id="details-btns" class="btn-group btn-group-justified" role="group">
							  <div class="btn-group " role="group">
							    <a href="<?php echo base_url('polls/edit/'.$row->id) ?>">
									<button class="btn btn-info btn-lg">Edit</button>
								</a>
							  </div>							  
							  <div class="btn-group" role="group">
							    <a href="<?php echo base_url('polls/delete/'.$row->id) ?>">
