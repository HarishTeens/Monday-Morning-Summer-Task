...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/cs/register.css') ?>">
		...
		<div class="container">
			...
			<div class="register">
				...
				<form method="POST" action="#">
					...
					<div class="form-group">
						<button class="btn btn-info btn-block" id="button">Register</button>
					</div>					
				</form>
			</div>
...
<!-- Sidebar  -->
		...
		<script  src="<?php echo base_url('assets/js/register');?>"></script>
